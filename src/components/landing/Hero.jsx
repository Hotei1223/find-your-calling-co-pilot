    ...
    return (
        <><div className="py-[60px]">
            <div className="flex flex-col items-center justify-center md:space-y-6 space-y-6">
                <h1 className="text-center text-white lg:text-[56px] md:text-[48px] text-[32px] leading-[40px] lg:leading-[60px] md:leading-[55px] font-bold lg:px-[160px] lg:tracking-wide">Welcome to Find Your Calling Paths</h1>
